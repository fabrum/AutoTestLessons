...
public class API_vk_test {



        String tokenForWall = "df6574eec02266e31097ffa16940e41799b1f75612badd2c0e51a8f6b20328e0df5a1df70f370aa8eee0e";
        String ownerId = "234109484";
        String versionApi ="5.101";
        private  static final Logger log = Logger.getLogger(API_vk_test.class);
        @Test
